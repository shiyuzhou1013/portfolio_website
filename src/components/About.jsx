        ...
        >
          <VStack spacing={4} align="left">
            ...
            <Text fontSize={{ base: "md", sm: "md", md: "lg" }}>
              ...
              grow, and make an impact. If you’re looking for someone who’s
              eager to take on new challenges and deliver results, download my{" "}
              <Link
            ...
            <Text fontSize={{ base: "md", sm: "md", md: "lg" }}>
              ...
              with new baking recipes 🍰, exploring my creativity through
              painting 🎨, or analyzing the latest trends in the stock market
              and reading financial reports 📈. These hobbies allow me to relax,
              express creativity, and keep a sharp eye on emerging
              opportunities.
            </Text>
          </VStack>
        </MotionBoxContainer>
